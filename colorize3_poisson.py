...
class FontColor(object):
    ...
    @staticmethod
    def sample_normal(col_mean, col_std):
        """
...
class Colorize(object):
    ...
    def __init__(self, model_dir='data'):  # , im_path):
        ...
        # self.bg_list = [p for p in im list if osp.isfile(p)]
    ...
    @staticmethod
    def drop_shadow(alpha, theta, shift, size, op=0.80):
        """
    ...
    @staticmethod
    def resize_im(im, o_size):
        return np.array(Image.fromarray(im).resize(o_size[::-1], Image.BICUBIC))
    ...
    @staticmethod
    def check_perceptible(txt_mask, bg, txt_bg):
        """
